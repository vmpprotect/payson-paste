...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderFloatNeon(const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool NeonTabs(const char* str_id, const char* tabs[], int tabs_count, int* current_tab);
    // Viewports
